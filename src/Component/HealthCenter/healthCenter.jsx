...
class ModalHealthCenter extends Component { 
    constructor(props){
        super(props);
        this.state={
            missions:[],
    ...
    componentDidMount(){
        ...
        this.props.countries.forEach(x=>{
            if(x.countryName === this.props.missions[this.props.user.userProfile.level].missions[3].country){
               countryInfo =x;
               gain = this.props.missions[this.props.user.userProfile.level].missions[3].kilos*x.mission[3].priceKilo

            }
        })
        
        this.setState({
            missions:[this.props.missions[this.props.user.userProfile.level].missions[3]],
                  ...
                  <div className='col-4'>
                        ...
                        {this.state.countryInfo.map((task,index)=>
                            <ul key={index+task.countryName} className='bold'>
                                ...
                                <li>{task.mission[3].material}</li>
                                <li>{task.mission[3].priceKilo}</li>
                                <li >{task.religion}</li>
                                <li>{task.taxes}</li>
                                <li>{this.state.missions[index].kilos*task.mission[3].priceKilo}</li>
    ...
    : <div className='mt-0'>
       <WorldMapBox countryInfo={this.state.countryInfo[0]} {...this.props}  thisMission={this.props.missions[1].missions[3]} gain={this.state.gain}></WorldMapBox>
 ...
 export default ModalHealthCenter;